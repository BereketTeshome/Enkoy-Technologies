    ...
    amh: {
      sections: [
        ...
        },
        {
          ...
          content:
            "አሳታፊ፣ ተደራሽ እና ለመፍጠር የሰውን ያማከለ ንድፍ (ኤች.ሲ.ዲ.ዲ) እና የመማር ልምድ ንድፍ (LXD) እንጠቀማለን። በተማሪ-ተኮር ልምዶች. በእንኮይ፣ መማር በጣም ውጤታማ የሚሆነው ግላዊ ሆኖ ሲሰማ እንደሆነ እንረዳለን። ይዘትን ከማድረስ አልፈን እንሄዳለን - በስሜት እና በእውቀት ከተማሪዎች ጋር የሚስማሙ ልምዶችን እንሰራለን። ርህራሄን በውስጣችን በማካተት ዲዛይኖች፣ ተማሪዎች መረጃን ብቻ እንደማይወስዱ እናረጋግጣለን። ከእሱ ጋር ይገናኙ, ያቆዩት እና ትርጉም ባለው መልኩ ይተግብሩ",
        },
        {
          img: "/img/services/gamificationImg.png",
          alt: "Gamification",
