...
const SelfPacedLearning = lazy(() =>
  import("./pages/servicePages/SelfPacedLearning")
);
const Gamification = lazy(() => import("./pages/servicePages/Gamification"));
const AnimatedVideos = lazy(() =>
  import("./pages/servicePages/AnimatedVideos")
);
...
const LearningExperiences = lazy(() =>
  import("./pages/servicePages/LearningExperiences")
);
const AnimationVideos = lazy(() =>
  import("./pages/servicePages/AnimationVideos")
);
const LXD = lazy(() => import("./pages/servicePages/LXD"));
const CorporateTraining = lazy(() => import("./pages/CorporateTraining"));
const LeadershipDevelopment = lazy(() =>
  import("./pages/corporateTrainingPages/LeadershipDevelopment")
);
const LearningExperience = lazy(() =>
  import("./pages/corporateTrainingPages/LearningExperience")
);
const AboutUs = lazy(() => import("./pages/AboutUs"));
const Story = lazy(() => import("./pages/servicePages/Story"));
const PersonalDevelopment = lazy(() =>
  import("./pages/corporateTrainingPages/PersonalDevelopment")
);
const BasicComputer = lazy(() =>
  import("./pages/corporateTrainingPages/BasicComputer")
);
const Employability = lazy(() =>
  import("./pages/corporateTrainingPages/Employability")
);
const DecentWork = lazy(() =>
  import("./pages/corporateTrainingPages/DecentWork")
);
const Safety = lazy(() => import("./pages/corporateTrainingPages/Safety"));
const FairEmployment = lazy(() =>
  import("./pages/corporateTrainingPages/FairEmployment")
);
...
const SoftSkill = lazy(() =>
  import("./pages/corporateTrainingPages/SoftSkill.jsx")
);
...
const InstructionalDesign = lazy(() =>
  import("./pages/servicePages/InstructionalDesign.jsx")
);
const TrainingDigitalization = lazy(() =>
  import("./pages/servicePages/TrainingDigitalization.jsx")
);
const VideoEditing = lazy(() =>
  import("./pages/servicePages/VideoEditing.jsx")
);
const GraphicsDesign = lazy(() =>
  import("./pages/servicePages/GraphicsDesign.jsx")
);
const BasicComputerSkill = lazy(() =>
  import("./pages/servicePages/BasicComputerSkill.jsx")
);
const EmployabilitySkill = lazy(() =>
  import("./pages/servicePages/EmployabilitySkill.jsx")
);
const PersonalDev = lazy(() => import("./pages/servicePages/PersonalDev.jsx"));
const LeadershipSkill = lazy(() =>
  import("./pages/servicePages/LeadershipSkill.jsx")
);
...
const DigitalTrainingOverview = lazy(() =>
  import("./pages/DigitalTrainingOverview.jsx")
);
